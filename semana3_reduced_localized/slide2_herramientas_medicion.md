...
lineNumbers: false
info: |
  ## Administración Estratégica para ONGs (Parte 2)
  Curso CD2001B - Diagnóstico para Líneas de Acción
  Tecnológico de Monterrey
drawings:
  persist: false
transition: slide-left
title: Herramientas y Medición - Teletón
mdc: true
download: true
exportFilename: semana3-parte2-herramientas-teleton
css: unocss
---
...
**S**pecific<br>(Específico)
</div>
<div class="bg-green-100 p-2 rounded">
**M**easurable<br>(Medible)
</div>
<div class="bg-yellow-100 p-2 rounded">
**A**chievable<br>(Alcanzable)
</div>
<div class="bg-red-100 p-2 rounded">
**R**elevant<br>(Relevante)
</div>
<div class="bg-purple-100 p-2 rounded">
**T**ime-bound<br>(Temporal)
</div>
</div>
...
<div v-click class="mt-4 p-2 bg-red-500 bg-opacity-10 rounded text-sm">
...
```mermaid
graph TD
    A[Nuevos Entrantes] --> C(Rivalidad Competitiva)
    B[Proveedores] --> C
    D[Clientes/Donantes] --> C
    E[Sustitutos] --> C
```
</div>
...
<div class="border p-2 rounded bg-gray-50 bg-opacity-5">
...
<div v-click class="mt-8 p-6 bg-cyan-500 bg-opacity-20 rounded-xl">
...
<div class="text-center p-6 bg-purple-600 text-white rounded-xl shadow-lg">
...
<div v-click class="mt-8 p-6 bg-gradient-to-r from-blue-500 to-green-500 bg-opacity-20 rounded-xl">
...
<div v-click class="mt-8 p-6 bg-gradient-to-r from-purple-500 to-pink-500 bg-opacity-30 rounded-xl text-lg font-bold">
